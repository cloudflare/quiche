...
/// Unified configuration parameters for [H3Driver](crate::http3::driver::H3Driver)s.
#[derive(Default, Clone, Debug)]
pub struct Http3Settings {
    /// Maximum number of requests a [ServerH3Driver](crate::http3::driver::ServerH3Driver)
    /// allows per connection.
    pub max_requests_per_connection: Option<u64>,
    /// Maximum size of a single HEADERS frame, in bytes.
    pub max_header_list_size: Option<u64>,
    /// Maximum value the QPACK encoder is permitted to set for the dynamic table capcity.
    /// See <https://www.rfc-editor.org/rfc/rfc9204.html#name-maximum-dynamic-table-capac>
    pub qpack_max_table_capacity: Option<u64>,
    /// Upper bound on the number of streams that can be blocked on the QPACK decoder.
    /// See <https://www.rfc-editor.org/rfc/rfc9204.html#name-blocked-streams>
    pub qpack_blocked_streams: Option<u64>,
    /// Timeout between starting the QUIC handshake and receiving the first request
    /// on a connection. Only applicable to [ServerH3Driver](crate::http3::driver::ServerH3Driver).
...
impl Http3SettingsEnforcer {
    /// Returns a boolean indicating whether or not the connection should be closed
    /// due to a violation of the request count limit.
    ...
    ///
    /// This function will automatically call `close()` on the underlying [quiche::Connection].
