...
use foundations::telemetry::metrics::{
    metrics, Counter, Gauge, Histogram, HistogramBuilder, TimeHistogram,
};
use std::net::IpAddr;
use std::sync::Arc;
...
pub trait Metrics: Send + Sync + Clone + Unpin + 'static {
    ...
    /// Number of H3 connection closures generated locally
    ...
    /// Number of H3 connection closures generated by peer
...
pub(crate) mod quic {
    ...
    pub fn handshake_time_seconds(stage: labels::QuicHandshakeStage) -> TimeHistogram;
    ...
    /// Number of QUIC packets received but not associated with an active connection
    pub fn rejected_initial_packet_count(reason: labels::QuicInvalidInitialPacketError) -> Counter;
    ...
    /// Number of Quic connection closures generated locally
    pub fn local_quic_conn_close_error_count(reason: labels::QuicError) -> Counter;

    /// Number of H3 connection closures generated by peer
    pub fn peer_h3_conn_close_error_count(reason: labels::H3Error) -> Counter;

    /// Number of Quic connection closures generated by peer
    pub fn peer_quic_conn_close_error_count(reason: labels::QuicError) -> Counter;
}
...
mod tokio {
    ...
    pub fn runtime_task_schedule_delay_histogram(task: &Arc<str>) -> TimeHistogram;

    /// Histogram of task poll durations
    #[ctor = HistogramBuilder { buckets: &[0.0, 1E-4, 2E-4, 3E-4, 4E-4, 5E-4, 6E-4, 7E-4, 8E-4, 9E-4, 1E-3, 1E-2, 2E-2, 4E-2, 8E-2, 1E-1, 1.0], }]
    pub fn runtime_task_poll_duration_histogram(task: &Arc<str>) -> TimeHistogram;
