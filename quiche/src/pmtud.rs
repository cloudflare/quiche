/// This file contains the logic to implement PMTUD. Given a range of
/// supported MTUs, finds the PMTU between the two.
...
impl Pmtud {
    ...
    pub fn new(
        ...
        assert!(minimum_supported_mtu >= MIN_CLIENT_INITIAL_LEN);
...
mod tests {
    ...
    fn pmtud_initial_state() {
        let mut pmtud = Pmtud::new(1200, 1350);
    ...
    fn pmtud_binary_search_algorithm() {
        let mut pmtud = Pmtud::new(1200, 1500);
    ...
    fn pmtud_successful_probe() {
        let mut pmtud = Pmtud::new(1200, 1400);
    ...
    fn pmtud_binary_search_convergence() {
        let mut pmtud = Pmtud::new(1200, 2000);
